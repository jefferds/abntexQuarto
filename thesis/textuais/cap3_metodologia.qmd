...
$$
\frac{T_{2,\text{pred}}}{T_1} = 1 + \frac{1}{\eta_c} \left( \left( \frac{P_{2,\text{pred}}}{P_1} \right)^{\frac{\gamma - 1}{\gamma}} - 1 \right)
$$
...
$$
L_{\text{comp}} = \left( \dot{m}_a c_p (T_{2,\text{pred}} - T_1) - W_{\text{comp}} \right)^2
$$

### Turbine Power Balance Loss ($L_{\text{turb}}$)

$$
L_{\text{turb}} = \left( \dot{m}_g c_p (T_{3,\text{pred}} - T_{4,\text{pred}}) - W_{\text{turb}} \right)^2
$$
...
$$
L_{\text{comb}} = \left( \dot{m}_f Q_{\text{HV}} - \dot{m}_g c_p (T_{3,\text{pred}} - T_{2,\text{pred}}) \right)^2
$$
...
$$
L_{\text{thrust}} = \left( F_{\text{pred}} - \dot{m}_g (V_{\text{exit}} - V_{\text{inlet}}) \right)^2
$$
